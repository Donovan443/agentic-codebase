...
\paragraph{Availability.} Source code is available at \url{https://github.com/agentralabs/agentic-codebase}. The system is implemented as a single Rust crate with two binaries.
